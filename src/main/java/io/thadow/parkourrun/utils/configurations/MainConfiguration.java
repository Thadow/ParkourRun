...
public class MainConfiguration extends ConfigurationManager {
    ...
    public static void init() {
        ...
        configuration.addDefault("Configuration.Lobby.Configurations.Disable Move Inv Items", true);
        configuration.addDefault("Configuration.Lobby.Configurations.Disable Hunger", true);
        ...
        configuration.addDefault("Configuration.Items.Lobby.Leave Item.Lobby Server", "hub1");
        configuration.addDefault("Configuration.Items.Arena.Checkpoint Item.Enabled", true);
        configuration.addDefault("Configuration.Items.Arena.Checkpoint Item.Item", "BEACON");
        configuration.addDefault("Configuration.Items.Arena.Checkpoint Item.Data", 0);
        configuration.addDefault("Configuration.Items.Arena.Checkpoint Item.Slot", 1);
        configuration.addDefault("Configuration.Items.Arena.Checkpoint Item.Name", "&aVolver al ultimo checkpoint.");
        configuration.addDefault("Configuration.Items.Arena.Checkpoint Item.Lore", Arrays.asList("&aClick derecho", "&apara volver al tu ultimo checkpoint!"));
        ...
        configuration.addDefault("Configuration.Arena Selector.Menu.Waiting.Item", "STAINED_GLASS");
        configuration.addDefault("Configuration.Arena Selector.Menu.Waiting.Data", "5");
        configuration.addDefault("Configuration.Arena Selector.Menu.Starting.Item", "STAINED_GLASS");
        configuration.addDefault("Configuration.Arena Selector.Menu.Starting.Data", "1");
        configuration.addDefault("Configuration.Arena Selector.Menu.Playing.Item", "STAINED_GLASS");
        configuration.addDefault("Configuration.Arena Selector.Menu.Playing.Data", "14");
        configuration.addDefault("Configuration.Arena Selector.Menu.Ending.Item", "STAINED_GLASS");
        configuration.addDefault("Configuration.Arena Selector.Menu.Ending.Data", "15");
        configuration.addDefault("Configuration.Arena Selector.Menu.Restarting.Item", "STAINED_GLASS");
        configuration.addDefault("Configuration.Arena Selector.Menu.Restarting.Data", "15");
        ...
        configuration.addDefault("Configuration.Arenas.Fireworks For Winner.Enabled", true);
        configuration.addDefault("Configuration.Arenas.Fireworks For Winner.Time", 4);
        ...
        configuration.addDefault("Configuration.Arenas.Configurations.Disable Move Inv Items", true);
        configuration.addDefault("Configuration.Arenas.Configurations.Disable Hunger", true);
